...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			t3 = space();
			add_location(button, file, 121, 8, 3445);
			add_location(li, file, 119, 6, 3416);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(h1, file, 109, 0, 3181);
			add_location(h20, file, 112, 2, 3215);
			attr_dev(input, "type", "file");
			input.multiple = true;
			add_location(input, file, 113, 2, 3236);
			add_location(p0, file, 114, 2, 3325);
			add_location(h3, file, 116, 2, 3351);
			add_location(ul, file, 117, 2, 3372);
			add_location(div0, file, 111, 0, 3207);
			add_location(h21, file, 128, 2, 3548);
			attr_dev(textarea, "placeholder", "궁금한 점을 물어보세요");
			add_location(textarea, file, 129, 2, 3562);
			add_location(button, file, 130, 2, 3641);
			add_location(p1, file, 131, 2, 3689);
			add_location(div1, file, 127, 0, 3540);
		},
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		pdfjsLib = await import('./pdf-1019ff42.js');
...
//# sourceMappingURL=main-b728efe4.js.map
